...
import numpy as np
from Projects.NERuselocal.model import Model
from Projects.NERuselocal.loader import load_sentences, update_tag_scheme
from Projects.NERuselocal.loader import char_mapping, tag_mapping
from Projects.NERuselocal.loader import augment_with_pretrained, prepare_dataset
from Projects.NERuselocal.utils import get_logger,load_config,create_model
from Projects.NERuselocal.utils import make_path
#from utils import get_logger, make_path, clean, create_model
from Projects.NERuselocal.utils import print_config, save_config, load_config, test_ner
from Projects.NERuselocal.data_utils import load_word2vec, create_input, input_from_line, BatchManager
...
flags.DEFINE_string("map_file",     "maps.pkl-bak",     "file for maps")
