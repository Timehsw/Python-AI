# -*- coding: utf-8 -*-
'''
    Created by hushiwei on 2018/10/17
    Desc : 绘制ks曲线
    Note : 
'''
...
class binary_evaluation:
    ...
    def plot_lorenz(self, color='red', legend='model', title='Lorenz_Curve', xlabel='Depth/RPP',
    ...
    def plot_precision_recall(self, color='red', legend='model', xlabel='recall', ylabel='precision',
