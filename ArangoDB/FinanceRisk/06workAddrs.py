...
if db.has_collection("WorkAddrs"):
    featureColleciton = db.collection("WorkAddrs")
else:
    featureColleciton = db.create_collection("WorkAddrs")
...
create_save_collections(featureColleciton, "workAddr", apply_df)
