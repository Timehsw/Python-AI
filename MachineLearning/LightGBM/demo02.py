...
test_point=gbm.predict(np.array([[0, 0.289, 0.823, 0.013, 0.615, -1.601, 0.177, 2.403, -0.015, 0.000, 0.258, 1.151, 1.036, 2.215, 0.694, 0.553, -1.326, 2.548, 0.411, 0.366, 0.106, 0.000, 0.482, 0.562, 0.989, 0.670, 0.404, 0.516, 0.561]]),num_iteration=gbm.best_iteration)
