...
'''
    ...
    Desc : baum-welch算法进行参数估计,计算pi,A,B
'''

import numpy as np

from MachineLearning.HMM.algorithm_implementation import common
from MachineLearning.HMM.algorithm_implementation import continuous_state_probability_of_ksi as continuous
...
if __name__ == '__main__':
    ...
    # baum_welch(pi, A, B, Q2, fetch_index_by_obs_seq=common.convert_obs_seq_2_index)
